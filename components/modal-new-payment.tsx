...
interface ModalNewPaymentProps {
  isOpen: boolean
  onClose: () => void
...
export const ModalNewPayment = ({
  isOpen,
  onClose,
  finalRef,
}: ModalNewPaymentProps) => {
                      ...
                      <FormControl>
                        ...
                        <InputGroup>
                          ...
                          <InputTheme
                            {...field}
                            type="tel"
                            placeholder="Ingresá un número de WhatsApp"
                            pl={10}
                          />
                        </InputGroup>
                      </FormControl>
                ...
                <Stack spacing={5}>
                  ...
                  <HStack alignItems="flex-start" spacing={2}>
                    ...
                    <Stack spacing={0}>
                      ...
                      <Text color="gray.600">
                        El cliente recibirá una confirmación de la
                        contabilización del pago justo a los detalles de la
                        factura.
                      </Text>
                    </Stack>
                  </HStack>
