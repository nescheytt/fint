                ...
                >
                  ...
                  <Stack alignItems="flex-start">
                    <Text lineHeight="20px" color="fint.800">
                      Necesita la autorización firmada de su cliente para
                      guardar su tarjeta y protegerlo de la responsabilidad de
                      devolución de cargo. Haga que su cliente complete y firme
                      este formulario, luego guárdelo de manera segura de
                      acuerdo con PCI-DSS y los requisitos de privacidad de
                      datos.
                    </Text>
                    <Button
                      colorScheme="fint"
                      variant="link"
                      onClick={() => console.log("Descargar formulario")}
                    >
