      ...
      <CardBody>
        ...
        >
          <HStack alignItems="center" spacing={0}>
            <Text w="44%" fontWeight={500} color="grayIron.800">
              Liquidación
            </Text>
            <Text w="56%" color="grayIron.700">
              Octubre 2023
            </Text>
          </HStack>
          <HStack alignItems="center" spacing={0}>
              ...
              <AccordionItem border={0}>
                <AccordionButton p={0}>
                  <HStack
                    ...
                    pb={4}
                  >
                    <Text fontSize="sm" fontWeight={600} color="grayIron.800">
                      Conceptos
                    </Text>
                    <AccordionIcon />
                  </HStack>
