...
const Installments: React.FC = () => {
  const [planSelected, setPlanSelected] = React.useState<MockDataTypes | undefined>(undefined);
  ...
  return (
    <>
      ...
      <DrawerSettings isOpen={isOpenDrawer} onClose={onCloseDrawer} plan={planSelected} />
      <ModalNewPlan isOpen={isOpenModal} onClose={onCloseModal} listItems={listItems} />
    </>
  );
};
