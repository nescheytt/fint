...
const PlanConcepts: FC = () => {
  return (
    <Card border="1px solid" borderColor="grayIron.200" borderRadius="xl" bg="white" boxShadow="xs" overflow="hidden">
      <CardHeaderDrawer title="Conceptos del plan" icon={{ name: 'FileText' }} button={{ text: 'Editar', onClick: () => console.log('onClick: Editar conceptos del plan') }} />
        ...
        <Stack spacing={0}>
          ...
          <HStack m={14} p={4} borderTop="1px solid" borderColor="grayIron.200" alignItems="flex-start" spacing={3} bgColor="grayIron.25">
            ...
            <Text lineHeight="20px" color="grayIron.700">
              Recuerda que solo podrás editar los conceptos mientras la factura no esté paga.
            </Text>
          </HStack>
        </Stack>
      </CardBody>
