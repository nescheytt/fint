...
import { Box, Button, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerHeader, HStack, Stack, Text, UseModalProps } from "@chakra-ui/react";
    ...
    <Drawer placement="right" isOpen={isOpen} onClose={onClose}>
      <DrawerContent bgColor="grayIron.50" boxShadow="xl" w={'full'} maxW={480}>
        ...
        <DrawerBody px={4} pt={0} pb={6}>
          ...
          <Box w='full' py={4} bgColor="grayIron.50" pos="sticky" bottom="-24px">
            <Button w='full' colorScheme="grayIron" onClick={() => console.log('onClick: Add student')}>Agregar estudiante</Button>
          </Box>
        </DrawerBody>
      </DrawerContent>
    </Drawer>
