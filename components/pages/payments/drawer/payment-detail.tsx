        ...
        <Box w="full">
          ...
          >
            <Stack spacing={4.5}>
              ...
              <HStack alignItems="center" spacing={2}>
                <Text w="70%" color="fint.600">
                  Comisión Procesamiento Fint (1%)
                </Text>
                <Text
                  w="30%"
                  color="fint.600"
            ...
            <Stack spacing={4.5}>
              <HStack alignItems="center" spacing={2}>
                <Text w="70%" color="gray.900" fontWeight={600} fontSize="md">
                  Total
                </Text>
                <Text
                  w="30%"
              ...
              <Badge
                ...
                textAlign="center"
              >
                A liquidarse el 23 Oct., 18:34hs.
              </Badge>
            </Stack>
          </Stack>
        </Box>
