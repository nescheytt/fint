...
const Details = (props: NavAccordionProps) => {
  ...
  return (
    ...
    >
      <Accordion allowToggle as="ul" listStyleType="none">
        {data.map((group) => (
          <AccordionItem key={group.title} as="li" borderEndStyle="none">
            <AccordionButton
              py="4"
              px={4}
            ...
            >
              ...
              <Badge colorScheme={group.dueAmount ? "red" : "orange"}>
                {group.due}
              </Badge>
            ...
            <AccordionPanel pb={3} px={4} pt={0}>
              ...
              <Flex
                ...
                marginBottom="5"
              >
                <Button variant="outline" colorScheme="blue" marginBottom={2}>
                  Pagar total ahora
                </Button>
