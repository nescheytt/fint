...
const linksTopSidebar = [
  ...
  },
  {
    href: '/payments',
    label: 'Pagos',
    icon: (isDesktop: boolean) => <ArrowRightCircle size={isDesktop ? 18 : 24} />
  },
  {
    href: '/bills',
    label: 'Facturas',
  ...
  return (
    <Box sx={sidebarStyles}>
      <Stack justify="space-between" h="100%" spacing={1}>
        <Stack spacing={1}>
          <Flex px={2.5} mb={5} justifyContent={isDesktop ? 'center' : 'flex-start'}>
            <Image w="64px" h="64px" src="https://cldup.com/VPAtm7IdU4.png" alt="Profile logo" borderRadius="lg" />
          </Flex>
